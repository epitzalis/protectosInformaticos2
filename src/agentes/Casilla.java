...
public class Casilla {
	...
	public static void comprarPropiedad(String idCasilla, String nombreCasilla, Jugador jugadorActual) {
		...
		if (numCasas != 5
				&& Util.pedirConfirmarCompraPropiedad(nombreCasilla, nombreNuevaAdquisicion, precioCompraCasilla)) {
	...
	public static void pagarAlquilerPropiedad(String idCasilla, String nombreCasilla, Jugador jugadorActual) {
		...
		System.out.println("Has caido en " + nombreCasilla + " que pertenece al " + propietarioCasilla
	...
	public static void pagarAlquilerEstacion(String idCasilla, String nombreCasilla, Jugador jugadorActual) {
		...
		System.out.println("Has caido en " + nombreCasilla + " que pertenece al " + propietarioCasilla + ",como tiene "
				+ cantidadEstacionesPropietario + " tienes que pagar " + cantidadPagar);
