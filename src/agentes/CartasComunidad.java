...
public class CartasComunidad {
	...
	public static void libreCarcel(Jugador jugadorActual) {
		...
		System.out.println(
				"Queda libre de la carcel, esta carta se puede usar cuando se crea oportuno. No se puede vender");
	}
	...
	public static void devoImp(Jugador jugadorActual) {
		...
		System.out.println("Devolucion de impuestos ganas 20€");
	}
	...
	public static void escola(Jugador jugadorActual) {
		...
		System.out.println("Matricula escolar pagas 150€");
	...
	public static void reparacion(Jugador jugadorActual) {
		...
		System.out.println("Tienes " + contadorCasas + " casas y " + contadorHotel
				+ " hoteles, tienes que pagar un total de: " + pagar);
	}
